  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="w-full h-11 rounded-lg border border-border bg-surface hover:bg-accent-light hover:shadow-[0_4px_16px_rgba(255,255,255,0.15)] transition-colors duration-150 flex items-center justify-center gap-3 text-sm font-medium text-text-primary disabled:opacity-50 disabled:cursor-not-allowed"
      >
